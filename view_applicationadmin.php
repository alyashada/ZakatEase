...
if (isset($_GET['user_id'])) {
    ...
    // Retrieve application information based on the user ID
...
?>
    ...
    <div class="container mt-5">
        <h3 style="text-align: center;">C. DEPENDENCY OF THE HEAD OF THE FAMILY (PARENT / GUARDIAN)</h3><br>
        <table class="table table-bordered table-hover-effect">
    ...
    <div class="container mt-5">
        ...
        <?php endif; ?>
        <br>
        <a href="listapplication.php" class="btn btn-secondary">Back to Student List</a><br><br><br>
    </div>
...
<?php
        ...
        echo "<p>No application found for the provided user ID.</p>";
    }
}
?>
</body>
