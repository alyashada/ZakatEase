...
// Fetch data from the registered_user table with usertype "student"
$query = "SELECT id, email, username, full_name, mobile_number, address_line_1, address_line_2, postcode, state FROM registered_user WHERE usertype = 'student'";
...
<?php
 ...
 echo '<br><br><br><br>';
    ...
    <h2 style="text-align: center;">Registered Students</h2><br>
    <form method="post" class="mb-3">
        <div class="input-group">
            <input type="text" name="search" class="form-control" placeholder="Search by full name" value="<?php echo isset($_POST['search']) ? htmlspecialchars($_POST['search']) : ''; ?>">
                ...
                while ($row = mysqli_fetch_assoc($result)) { ?>
                    <tr>
                        ...
                        <div class="d-flex">
                            ...
                            <a href="userliststudelete.php?id=<?php echo $row['id']; ?>" class="btn btn-danger btn-sm">
    ...
    document.querySelectorAll('.edit-btn').forEach(btn => {
        btn.addEventListener('click', function() {
            ...
            const formHTML = `
                <form id="editForm" action="userliststuedit.php" method="post">
